...
**Wichtig:** Die Pipeline-Datei ist lokal erstellt, aber noch nicht gepusht – ich kann den tatsächlichen Lauf auf GitHub von hier aus nicht verifizieren. Nach dem Push: Tab "Actions" im Repo zeigt den Lauf, das Artefakt liegt am Ende des Laufs unter "Artifacts" zum Download bereit.
